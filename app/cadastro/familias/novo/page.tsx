...
import { Shirt, Save, ArrowLeft, AlertCircle, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Nova Família</h1>
                <p className="text-cyan-100">Cadastrar nova família de produtos</p>
              </div>
            </div>
